...
var utils = {
	...
	initUrlMap : function(){
		...
		utils.urlMap.put( hostname , 'http://172.30.176.17:8080');
		utils.urlMap.put('172.30.176.17' , 'http://172.30.176.17:8080');
		utils.urlMap.put('172.30.30.176' , 'http://172.30.30.176:8080');
		// utils.urlMap.put('172.30.41.86' , 'http://172.30.41.37:8080');
		// utils.urlMap.put('172.30.41.86' , 'http://172.30.11.67:8080');
		utils.urlMap.put('172.30.41.86' , 'http://172.30.41.111:8080');
		utils.urlMap.put('admin.baleshop.tw' , 'http://api.baleshop.tw');
		utils.urlMap.put('admin.91up.com.tw' , 'http://api.91up.com.tw');
	},
	perviewPath : function(id){
		if(utils.prePath().indexOf('api.baleshop.tw') > 0){
			return 'http://www.91up.com.tw/product/index.html?id='+id + '&source=admin';
		}else {
			return 'http://172.30.11.67:9080/product/index.html?id='+id + '&source=admin';
		}
	},
	perviewSinglePath: function (id) {
		if (window.location.host == '172.30.30.156:5500'){
			...
			return 'https://www.91up.com.tw/singlePage/index.html?id=' + id;
		} else {
			return 'http://172.30.11.67:9080/singlePage/index.html?id=' + id;
		}
	},
